...
public partial class WebForm_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            string strMcd = Request.QueryString["mcd"].ToString();
            ...
            lstSachTheoDanhMuc.DataSource = XL_DuLieu.Doc_bang("select " + strTemp + " where mcd = " + strMcd);
            lstSachTheoDanhMuc.DataBind();
        }
    }
