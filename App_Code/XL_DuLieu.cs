...
public class XL_DuLieu
{
    ...
    public static String chuoi_ket_noi = @"Server=DANGLAI_PC\DANGLAI_PC; Database=QL_BanSach;Integrated Security=True";
    //public static String chuoi_ket_noi = @"Server=DESKTOP-I6D6J0Q\SQLEXPRESS;Database=QL_BANSACH;Integrated Security=True";

    //public static String chuoi_ket_noi = @"Server=TTTV-02\SQLEXPRESS;Database=QL_BANSACH;Integrated Security=True";
    //public static String chuoiKetNoi = @"Server=May-16;Database=QL_BANSACH"
    ...
    public static DataTable gioHang()
    {
        ...
        gioHang.Columns.Add("ms", typeof(int));
        gioHang.Columns.Add("hinhMinhHoa", typeof(string));
